...
##
##  uses raw LUN service time as example
##
...
stats '/Volumes/External300/DBProgs/FSRServers/DougPerfData/Graph-LongLine/GPlotData/iostat_timeasvct-cppsd09a0100-201505161717_201505221124.dat'
...
fpow(x) = apow*x**bpow    ##  takes too long for iostat_asvct (raw service times)
flin(x) = alin*x+blin     ##  works for iostat_asvct (raw service times)
...
fit flin(x) '/Volumes/External300/DBProgs/FSRServers/DougPerfData/Graph-LongLine/GPlotData/iostat_asvct-cppsd09a0100-201505161717_201505221124.dat' via alin,blin
...
##  fit fmean(x) '/Volumes/External300/DBProgs/FSRServers/DougPerfData/Graph-LongLine/GPlotData/iostat_asvct-cppsd09a0100-201505161717_201505221124.dat' via mean_y
...
set output "PlotTest-LinearTrend.png"
set autoscale
##  unset log
##  unset label
##  unset object
...
##  plot '/Volumes/External300/DBProgs/FSRServers/DougPerfData/Graph-LongLine/GPlotData/iostat_timeasvct-cppsd09a0100-201505161717_201505221124.dat' using 1:2 with linespoints linestyle 1 title 'data points' axes x1y1
